...
public:
	...
	struct FString                                     DefaultFilmbackPresetName;                                // 0x09F0(0x0010) (ZeroConstructor, Config)
	struct FString                                     DefaultLensPresetName;                                    // 0x0A00(0x0010) (ZeroConstructor, Config)
