...
#include "UE4_WBP_LoadoutsPanel_classes.hpp"
...
struct UWBP_LoadoutsPanel_C_GetDeployableClass_Params
{
	struct FString                                     Name;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor)
	class UClass*                                      Item_Info;                                                // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
};
...
struct UWBP_LoadoutsPanel_C_Switch_To_Augment_Selection_Params
{
};
...
struct UWBP_LoadoutsPanel_C_BndEvt__WBP_Loadouts_PackButton_K2Node_ComponentBoundEvent_408_ButtonClicked__DelegateSignature_Params
{
...
struct UWBP_LoadoutsPanel_C_Primary_Augment_Updated_Params
{
...
struct UWBP_LoadoutsPanel_C_Secondary_Augment_Updated_Params
{
	class UClass*                                      Augment;                                                  // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	struct FText                                       Suffix_Text;                                              // (BlueprintVisible, BlueprintReadOnly, Parm)
	struct FText                                       Error_Text;                                               // (BlueprintVisible, BlueprintReadOnly, Parm)
...
struct UWBP_LoadoutsPanel_C_DisplayLoadoutEquippedToast_Params
{
};
...
struct UWBP_LoadoutsPanel_C_BndEvt__WBP_LoadoutPackConfiguration_K2Node_ComponentBoundEvent_12_JumpToObject__DelegateSignature_Params
{
	class UClass*                                      Object_Info;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UWBP_LoadoutsPanel_C_BndEvt__GamemodeSelection_K2Node_ComponentBoundEvent_116_OnSelectionChangedEvent__DelegateSignature_Params
{
