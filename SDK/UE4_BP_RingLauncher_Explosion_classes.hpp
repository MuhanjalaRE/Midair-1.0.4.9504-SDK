...
#include "UE4_BP_RingLauncher_Explosion_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_RingLauncher_Explosion.BP_RingLauncher_Explosion_C");
		return ptr;
	}
