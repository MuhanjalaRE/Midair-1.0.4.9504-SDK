...
#include "UE4_WBP_MapVote_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_MapVote.WBP_MapVote_C.Get_VoteText_Text_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_MapVote.WBP_MapVote_C.BndEvt__Button_70_K2Node_ComponentBoundEvent_147_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_MapVote.WBP_MapVote_C.Construct");
...
void UWBP_MapVote_C::Tick(struct FGeometry* MyGeometry, float* InDeltaTime)
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_MapVote.WBP_MapVote_C.Tick");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_MapVote.WBP_MapVote_C.RefreshName");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_MapVote.WBP_MapVote_C.ExecuteUbergraph_WBP_MapVote");
