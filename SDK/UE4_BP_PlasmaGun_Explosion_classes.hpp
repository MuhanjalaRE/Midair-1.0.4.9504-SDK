...
#include "UE4_BP_PlasmaGun_Explosion_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_PlasmaGun_Explosion.BP_PlasmaGun_Explosion_C");
		return ptr;
	}
