...
#include "UE4_WBP_PartyFriendsDivider_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WBP_PartyFriendsDivider.WBP_PartyFriendsDivider_C");
		return ptr;
	}
