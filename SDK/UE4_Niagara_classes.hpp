...
{
public:
	class UNiagaraEffect*                              Asset;                                                    // 0x0810(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0818(0x0010) MISSED OFFSET
	TArray<struct FNiagaraVariable>                    EffectParameterLocalOverrides;                            // 0x0828(0x0010) (Edit, ZeroConstructor)
	TArray<struct FNiagaraScriptDataInterfaceInfo>     EffectDataInterfaceLocalOverrides;                        // 0x0838(0x0010) (Edit, ZeroConstructor)
	TArray<class UNiagaraDataInterface*>               InstanceDataInterfaces;                                   // 0x0848(0x0010) (ZeroConstructor, Transient, DuplicateTransient)
	bool                                               bRenderingEnabled;                                        // 0x0858(0x0001) (ZeroConstructor, IsPlainOldData)
