...
#include "UE4_BP_ConcGrenadeExplosion_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_ConcGrenadeExplosion.BP_ConcGrenadeExplosion_C.UserConstructionScript");
