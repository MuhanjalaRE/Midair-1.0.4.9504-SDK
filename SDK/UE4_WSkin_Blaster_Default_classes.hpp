...
#include "UE4_WSkin_Blaster_Default_structs.hpp"
...
class AWSkin_Blaster_Default_C : public AWSkin_DefaultSetup_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass WSkin_Blaster_Default.WSkin_Blaster_Default_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WSkin_Blaster_Default(int EntryPoint);
};
