...
#include "UE4_BP_GrenadeLauncher_Explosion_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_GrenadeLauncher_Explosion.BP_GrenadeLauncher_Explosion_C");
		return ptr;
	}
