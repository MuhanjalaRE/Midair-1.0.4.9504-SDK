...
struct ASteamBeaconPlayerController_ServerUpdateMatchMakingLobbySession_Params
{
...
struct ASteamBeaconPlayerController_OnJoinMatchMakingLobbySession_Params
{
	unsigned char                                      MatchType;                                                // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	struct FBlueprintSessionResult                     SessionResult;                                            // (ConstParm, Parm, ReferenceParm)
};
