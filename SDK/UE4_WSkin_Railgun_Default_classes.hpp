...
#include "UE4_WSkin_Railgun_Default_structs.hpp"
...
// BlueprintGeneratedClass WSkin_Railgun_Default.WSkin_Railgun_Default_C
// 0x0030 (0x0430 - 0x0400)
class AWSkin_Railgun_Default_C : public AWSkin_DefaultSetup_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass WSkin_Railgun_Default.WSkin_Railgun_Default_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WSkin_Railgun_Default(int EntryPoint);
};
