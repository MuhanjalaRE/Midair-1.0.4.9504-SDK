...
#include "UE4_WBP_EventFeedSlot_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_EventFeedSlot.WBP_EventFeedSlot_C.GetBrushColor_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_EventFeedSlot.WBP_EventFeedSlot_C.Set Text Color");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_EventFeedSlot.WBP_EventFeedSlot_C.Update View Target Player State");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_EventFeedSlot.WBP_EventFeedSlot_C.Get_DamageTypeIcon_Brush_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_EventFeedSlot.WBP_EventFeedSlot_C.Set Text");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_EventFeedSlot.WBP_EventFeedSlot_C.Fill");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_EventFeedSlot.WBP_EventFeedSlot_C.Construct");
...
void UWBP_EventFeedSlot_C::Tick(struct FGeometry* MyGeometry, float* InDeltaTime)
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_EventFeedSlot.WBP_EventFeedSlot_C.Tick");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_EventFeedSlot.WBP_EventFeedSlot_C.ExecuteUbergraph_WBP_EventFeedSlot");
