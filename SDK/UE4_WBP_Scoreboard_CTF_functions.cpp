...
#include "UE4_WBP_Scoreboard_CTF_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_Scoreboard_CTF.WBP_Scoreboard_CTF_C.InitCustomPinnedStats");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_Scoreboard_CTF.WBP_Scoreboard_CTF_C.UpdatePlayerStatBox");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_Scoreboard_CTF.WBP_Scoreboard_CTF_C.Construct");
...
void UWBP_Scoreboard_CTF_C::Tick(struct FGeometry* MyGeometry, float* InDeltaTime)
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_Scoreboard_CTF.WBP_Scoreboard_CTF_C.Tick");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_Scoreboard_CTF.WBP_Scoreboard_CTF_C.ExecuteUbergraph_WBP_Scoreboard_CTF");
