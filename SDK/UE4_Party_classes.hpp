...
public:
	...
	unsigned char                                      UnknownData04[0x110];                                     // 0x0190(0x0110) MISSED OFFSET
	class UClass*                                      ReservationBeaconClientClass;                             // 0x02A0(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	class APartyBeaconClient*                          ReservationBeaconClient;                                  // 0x02A8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData05[0x330];                                     // 0x02B0(0x0330) MISSED OFFSET
