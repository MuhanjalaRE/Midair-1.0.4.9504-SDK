...
#include "UE4_WBP_VideoSettings_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_VideoSettings.WBP_VideoSettings_C.Get_ResolutionBox_bIsEnabled_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_VideoSettings.WBP_VideoSettings_C.On_ResolutionBox_GenerateWidget_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_VideoSettings.WBP_VideoSettings_C.Apply Settings");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_VideoSettings.WBP_VideoSettings_C.Construct");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_VideoSettings.WBP_VideoSettings_C.BndEvt__FOV_Slider_K2Node_ComponentBoundEvent_36_ValueAdjusted__DelegateSignature");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_VideoSettings.WBP_VideoSettings_C.BndEvt__FOV_Slider_K2Node_ComponentBoundEvent_41_ValueApplied__DelegateSignature");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_VideoSettings.WBP_VideoSettings_C.FOV_Value");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_VideoSettings.WBP_VideoSettings_C.Reset");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_VideoSettings.WBP_VideoSettings_C.Set Radio Option to Default");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_VideoSettings.WBP_VideoSettings_C.BndEvt__ApplyButton_K2Node_ComponentBoundEvent_40_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_VideoSettings.WBP_VideoSettings_C.BndEvt__ResetButton_K2Node_ComponentBoundEvent_57_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_VideoSettings.WBP_VideoSettings_C.ExecuteUbergraph_WBP_VideoSettings");
