...
#include "UE4_WSkin_Mortar_Default_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass WSkin_Mortar_Default.WSkin_Mortar_Default_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WSkin_Mortar_Default(int EntryPoint);
};
