...
struct FBodyInstance
{
	...
	unsigned char                                      UnknownData08[0xF8];                                      // 0x012C(0x00F8) MISSED OFFSET
	...
	unsigned char                                      UnknownData09[0x8];                                       // 0x0228(0x0008) MISSED OFFSET
};
...
struct FMeshProxySettings
{
	...
	bool                                               bRecalculateNormals;                                      // 0x00B4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bBakeVertexData;                                          // 0x00B5(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bUseLandscapeCulling;                                     // 0x00B6(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ELandscapeCullingPrecision>            LandscapeCullingPrecision;                                // 0x00B7(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAssignLODGroup;                                          // 0x00B8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FRadialDamageParams
{
	...
	float                                              BaseImpulseMag;                                           // 0x0014(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinImpulseMag;                                            // 0x0018(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
{
	struct FRadialDamageParams                         Params;                                                   // 0x0010(0x001C)
...
struct FPointDamageEvent : public FDamageEvent
{
	...
	float                                              ImpulseMag;                                               // 0x0014(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FVector_NetQuantizeNormal                   ShotDirection;                                            // 0x0018(0x000C)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0024(0x0004) MISSED OFFSET
...
struct FMeshMergingSettings
{
	...
	unsigned char                                      UnknownData01[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	struct FMaterialProxySettings                      MaterialSettings;                                         // 0x0014(0x0094) (Edit, BlueprintVisible)
	bool                                               bBakeVertexDataToMesh;                                    // 0x00A8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseVertexDataForBakingMaterial;                          // 0x00A9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseTextureBinning;                                       // 0x00AA(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCalculateCorrectLODModel;                                // 0x00AB(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	EMeshLODSelectionType                              LODSelectionType;                                         // 0x00AC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	int                                                SpecificLOD;                                              // 0x00B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLandscapeCulling;                                     // 0x00B8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FHierarchicalSimplification
{
	...
	struct FMeshMergingSettings                        MergeSetting;                                             // 0x00D0(0x00C8) (Edit)
	float                                              DesiredBoundRadius;                                       // 0x0198(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DesiredFillingPercentage;                                 // 0x019C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MinNumberOfActorsToBuild;                                 // 0x01A0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
