...
#include "UE4_WBP_PunishVoteDisplay_structs.hpp"
...
public:
	...
	struct FPunishVote                                 ActivePunishVote;                                         // 0x02A0(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WBP_PunishVoteDisplay.WBP_PunishVoteDisplay_C");
		return ptr;
	}
