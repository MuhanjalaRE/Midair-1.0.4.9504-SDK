...
#include "UE4_WBP_PunishVoteDisplay_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_PunishVoteDisplay.WBP_PunishVoteDisplay_C.Get_VoteOptionNo_Text_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_PunishVoteDisplay.WBP_PunishVoteDisplay_C.Get_VoteOptionYes_Text_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_PunishVoteDisplay.WBP_PunishVoteDisplay_C.Get_VoteDisplayNameText_Text_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_PunishVoteDisplay.WBP_PunishVoteDisplay_C.Construct");
...
void UWBP_PunishVoteDisplay_C::Tick(struct FGeometry* MyGeometry, float* InDeltaTime)
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_PunishVoteDisplay.WBP_PunishVoteDisplay_C.Tick");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_PunishVoteDisplay.WBP_PunishVoteDisplay_C.ConditionallyContinueAnimation");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function WBP_PunishVoteDisplay.WBP_PunishVoteDisplay_C.ExecuteUbergraph_WBP_PunishVoteDisplay");
